...
import { bookingStatusLabels, type BookingValidationStatus } from '@/lib/booking-status';
...
export default function BookingSuccessScreen() {
  ...
  const [status, setStatus] = useState<BookingValidationStatus>('pending');
  ...
  const statusQuery = trpc.booking.getStatus.useQuery({ bookingCode }, { refetchInterval: submitted ? 15000 : false });
